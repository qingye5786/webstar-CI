...
* 全选操作
+--------------------------------------------------------------
* @param n 传过来需要操作的checkbox最外围的id
+--------------------------------------------------------------
*/
function selectAll(f,n) { 
	var obj = document.getElementById(n).getElementsByTagName('input');
	if(f.checked == true) {
...
function delAll(url) {
	if(confirm('你确定全部删除?')) {
		document.myform.action=url+"/admin/article/deleteAll/";
